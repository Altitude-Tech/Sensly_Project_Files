...
try:
    ...
    output = "python stm32loader.py -e -w -v -p " + port + " -b 115200 Sensly_HAT_Firmware_V1_5-Calibration.bin"
    #output = "python stm32loader.py -e -w -v -p /dev/serial0 -b 115200 Sensly_Firmware_HAT_V1_5-Calibration.bin"    
